"""
This file is the homepage where all the files are referenced from.
"""
...
st.markdown("""
QuickVU (Quick Visual Understanding) is an easy-to-use tool for 
data preparation, analysis, and visualization. It helps you clean, explore, 
and visualize your data without coding.

Just upload your data, choose your analysis, and Quick VU will guide you 
through the process.
...
st.markdown("""
### Tools & Features
QuickVU provides several powerful features to streamline your data analysis 
workflow:

- **Data Preparation via QuickPrep**: Easily clean and preprocess your 
data before analysis.
- **Data Analysis via QuickGlance**: Use built-in analytics tools to perform 
various statistical analyses on your datasets.
